    ...
    <v-card class="card" @click="click()">
        <div class="container">
            <div class="name-container">
                ...
                <div class="info-row">
                    <div class="text-small info-item">
                        <v-icon icon="mdi-account-outline" size="14" :color="'#8a8a8a'" class="info-icon"></v-icon>
                    ...
                    <div class="text-small info-item">
                        <v-icon icon="mdi-certificate-outline" size="14" :color="'#8a8a8a'" class="info-icon"></v-icon>

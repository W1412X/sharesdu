...
本文档描述 ShareSDU 后端 API 的接口规范和使用方法。

## 📚 文档导航

- [认证机制](#0自定义jwt认证以及部分规范)
- [邀请码管理](#05-邀请码管理板块)
- [账户板块](#1账户板块登录登出注册注销)
- [用户板块](#15-用户板块)
- [黑名单板块](#2黑名单板块)
...
- **[待办事项](./TODO.md)** - 查看未来计划和待开发功能
- **[前端文档](./web/docs/README.md)** - Web 前端技术文档

## 🌐 API 基础信息

- **Base URL**: `https://api.sharesdu.com/index/api`
- **协议**: HTTPS
- **数据格式**: JSON
- **字符编码**: UTF-8
...
### URL 规范
- 所有请求 URL 末尾**不包含** `/`
- 示例：`/index/api/test` ✅  `/index/api/test/` ❌
